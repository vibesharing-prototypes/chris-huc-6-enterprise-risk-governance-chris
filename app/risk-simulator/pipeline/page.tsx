...
export default function RiskPipelinePage() {
  ...
  const stagesData = result?.pipeline?.stages ?? STAGES;
  const evidenceData = result?.pipeline?.evidence ?? EVIDENCE;
  ...
  return (
    <SimulatorShell breadcrumb="Risk Pipeline">
      {/* Title */}
      ...
      <div>
        <div className="flex gap-6">
          ...
          <div className="w-[380px] flex-shrink-0 space-y-5">
            ...
            <EvidenceDrawer evidence={evidenceData} selectedStage={selectedStage} />
